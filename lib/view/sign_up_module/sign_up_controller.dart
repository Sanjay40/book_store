...
class SignUpController extends GetxController{
  ...
  checkValidation(){
    ...
    else if(Global.confirmPassword.text.trim().isEmpty)
    {
    ...
    else if(Global.confirmPassword.text.trim().length < 8)
    {
      Utils.showToast("Please Enter Valid confirm password");
    }
    else if(Global.password.text.trim() != Global.confirmPassword.text.trim())
    {
